...
│   │                  │  │                  │  │                │   │
│   │ Baseline x2(ASG) │  │ Keycloak, MLflow │  │ Internal ALB   │   │
│   │ +Burst(Karpenter)│  │ JupyterHub, Ray  │  │ RDS PostgreSQL │   │
│   │ EFA, NCCL, FSx   │  │ OSMO, Grafana    │  │ FSx for Lustre │   │
...
| 서브넷 | CIDR | IPs | 용도 |
|--------|------|-----|------|
| GPU Compute | 10.100.0.0/24 | 254 | g7e.48xlarge 노드 (Baseline ASG + Burst Karpenter) + Pod |
