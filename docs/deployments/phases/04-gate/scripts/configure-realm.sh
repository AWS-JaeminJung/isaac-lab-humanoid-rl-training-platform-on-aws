...
#   3. Creates 4 roles: researcher (gpu_quota=16), engineer (gpu_quota=32), admin (gpu_quota=80), viewer
...
log_info "Roles: researcher (gpu_quota=16), engineer (gpu_quota=32), admin (gpu_quota=80), viewer (gpu_quota=0)"
