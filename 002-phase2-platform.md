...
┌─ GPU Nodes (Karpenter, g7e.48xlarge x0~10) ─────────────────────┐
...
│  │   EFA: enabled                                        │      │
│  │   Scale: 0 → 10 (auto-provision on training request)   │      │
│  └───────────────────────────────────────────────────────┘      │
│                                                                 │
│  Per Node:                                                      │
...
- [ ] Karpenter 설치 → GPU Pod 배포 시 g7e.48xlarge 프로비저닝 확인
